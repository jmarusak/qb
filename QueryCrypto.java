...
{    
    ...
    public static void main(String[] args) throws Exception {
        if(args.length != 2) {
            System.out.println();
            System.out.println("QueryCrypto: Release 1.0");
            System.out.println();
        ...
        String enc=QueryCrypto.encrypt(key, plain);
        String plainAfter=QueryCrypto.decrypt(key, enc);
        
        System.out.println(); 
        System.out.println("Key: "+key);
        System.out.println("Pwd: "+plainAfter);
        System.out.println("Pwd: "+enc);
        System.out.println("Sql: "+"UPDATE databases SET password = '"+enc+"' WHERE database_name = ''");
    }
}
